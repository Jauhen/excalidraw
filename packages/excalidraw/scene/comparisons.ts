import { getPeculiarElementImplementation } from "../element/peculiarElement";
...
export const hasBackground = (
  ...
  type === "freedraw" ||
  (type === "peculiar" &&
    getPeculiarElementImplementation(customType!).hasBackgroundColor());
...
export const hasStrokeColor = (
  ...
  return (
    ...
    type !== "magicframe" &&
    (type !== "peculiar" ||
      getPeculiarElementImplementation(customType!).hasStrokeColor())
  );
};
...
export const hasStrokeWidth = (
  ...
  type === "line" ||
  (type === "peculiar" &&
    getPeculiarElementImplementation(customType!).hasStrokeWidth());
...
export const hasStrokeStyle = (
  ...
  type === "line" ||
  (type === "peculiar" &&
    getPeculiarElementImplementation(customType!).hasStrokeStyle());
...
export const canChangeRoundness = (
  ...
  type === "image" ||
  (type === "peculiar" &&
    getPeculiarElementImplementation(customType!).hasRoundness());
...
export const toolIsArrow = (
  ...
  type === "arrow" ||
  (type === "peculiar" &&
    getPeculiarElementImplementation(customType!).hasArrow());
