...
import { registerPeculiarElement } from "../../element/customElement";
...
export class API {
  ...
  static registerPeculiarElement = (peculiarType: string, implementation: ExcalidrawPeculiarElementImplementation) => {
