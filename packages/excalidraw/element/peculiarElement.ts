...
export const getPeculiarElement = (
  ...
  return registeredPeculiarElements[peculiarType] || getDefaultPeculiarElementImplementation;
};
...
export const getPeculiarTool = (
  ...
  return registeredPeculiarTools[peculiarType] || getDefaultPeculiarToolImplementation;
};
