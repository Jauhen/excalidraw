...
class App extends React.Component<AppProps, AppState> {
  ...
  private handleCanvasPointerMove = (
    ...
    if (multiElement && multiElement.type !== "peculiar") {
      ...
      getPeculiarElement(multiElement.peculiarType).mutateElement(
        multiElement,
        {
          customData: {
  ...
  private mutatePeculiarElementOnPointMove = (
    ...
    getPeculiarElement(newElement.peculiarType).handlePointerMove(
      newElement,
      pointerDownState,
      event,
      this.state,
  ...
  private onPointerUpFromPointerDownHandler(
    ...
    return withBatchedUpdates((childEvent: PointerEvent) => {
      ...
      if (newElement?.type === "peculiar") {
        const stateUpdate = getPeculiarElement(
