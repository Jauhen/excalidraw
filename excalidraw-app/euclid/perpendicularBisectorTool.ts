...
import { getStrokeWidthByKey, updateActiveTool } from "@excalidraw/common";
...
export const EUCLID_PERPENDICULAR_BISECTOR_TOOL =
  "euclid-perpendicular-bisector-tool";

export const euclidPerpendicularBisectorToolImplementation: ExcalidrawPeculiarToolImplementation =
  createPeculiarToolImplementation({
    handlePointerDown: (
      ...
      newElement: NonDeleted<EuclidLineElement>;
      elements: { index: number; element: ExcalidrawElement }[];
      multiElement: NonDeleted<EuclidLineElement> | null;
    } => {
